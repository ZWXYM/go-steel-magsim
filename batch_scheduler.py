...
# PowerShell脚本生成
# ========================================
def generate_multi_config_powershell_script(selected_configs, output_filename):
...
# Copy parameter template to base directory
$paramTemplate = "grain_scripts\\{config_name}\\simulation_parameters_template.txt"
...
"""
            ...
            script += f"""
# Multi-config mode - create config subdirectory
$configDir = "$outputBase\\{config_name}"
